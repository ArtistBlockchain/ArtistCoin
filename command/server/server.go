...
import (
	...
	"github.com/ArtistBlockchain/ArtistCoin/command/server/config"
	"github.com/ArtistBlockchain/ArtistCoin/command/server/export"
	"github.com/ArtistBlockchain/ArtistCoin/server"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the ArtistCoin client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing ArtistCoin client data",
	)
