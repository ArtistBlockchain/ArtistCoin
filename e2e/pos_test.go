...
import (
	...
	ibftOp "github.com/ArtistBlockchain/ArtistCoin/consensus/ibft/proto"
	"github.com/ArtistBlockchain/ArtistCoin/contracts/staking"
	"github.com/ArtistBlockchain/ArtistCoin/crypto"
	"github.com/ArtistBlockchain/ArtistCoin/e2e/framework"
	stakingHelper "github.com/ArtistBlockchain/ArtistCoin/helper/staking"
	"github.com/ArtistBlockchain/ArtistCoin/helper/tests"
	txpoolOp "github.com/ArtistBlockchain/ArtistCoin/txpool/proto"
	...
	ibftManager := framework.NewIBFTServersManager(
		...
		func(i int, config *framework.TestServerConfig) {
			...
			if i < numGenesisValidators {
				...
				dirPrefix := "artistcoin-non-validator-"
